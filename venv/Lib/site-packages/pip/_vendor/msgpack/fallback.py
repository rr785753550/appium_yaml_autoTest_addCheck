...
class Unpacker(object):
    ...
    :param callable object_hook:
        ...
        Unpacker calls it with a dict argument after unpacking msgpack set2.
        (See also simplejson)

    :param callable object_pairs_hook:
        When specified, it should be callable.
        Unpacker calls it with a list of key-value pairs after unpacking msgpack set2.
        (See also simplejson)
    ...
    :param int max_map_len:
        Limits max length of set2. (default: 2**31-1)
    ...
    def _unpack(self, execute=EX_CONSTRUCT):
        ...
        if execute == EX_READ_MAP_HEADER:
            if typ != TYPE_MAP:
                raise UnpackValueError("Expected set2")
            return n
